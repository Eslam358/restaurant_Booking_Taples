...
import { useApp } from "@/contexts/app-context"; // تأكد أن عندك الـ context يحتوي على الدالة t
...
export function useProducts() {
  ...
  const featuredProducts = [
    ...
    {
      id: 2,
      title: t("baconDeluxeTitle"),
      desc: t("baconDeluxeDesc"),
    ...
    {
      id: 3,
      title: t("bellaNapoliTitle"),
      desc: t("bellaNapoliDesc"),
    ...
    {
      id: 4,
      title: t("spicyArrabbiataTitle"),
      desc: t("spicyArrabbiataDesc"),
    ...
    {
      id: 5,
      title: t("jalapenoFiestaTitle"),
      desc: t("jalapenoFiestaDesc"),
    ...
    {
      id: 6,
      title: t("margheritaMagicTitle"),
      desc: t("margheritaMagicDesc"),
    ...
    {
      id: 7,
      title: t("garlicParmesanTitle"),
      desc: t("garlicParmesanDesc"),
    ...
    {
      id: 8,
      title: t("mediterraneanDelightTitle"),
      desc: t("mediterraneanDelightDesc"),
    ...
    {
      id: 9,
      title: t("hawaiianTeriyakiTitle"),
      desc: t("hawaiianTeriyakiDesc"),
  ...
  const pizzas = [
    ...
    {
      id: 42,
      title: t("pestoPrimaveraTitle"),
      desc: t("pestoPrimaveraDesc"),
    ...
    {
      id: 52,
      title: t("veggieSupremeTitle"),
      desc: t("veggieSupremeDesc"),
    ...
    {
      id: 62,
      title: t("fourCheeseFantasyTitle"),
      desc: t("fourCheeseFantasyDesc"),
  ...
  return { featuredProducts, pizzas };
}
